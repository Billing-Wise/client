...
export default {
  ...
  computed: {
    ...mapStores(useMobileStore, useConsentContractInfoStore, useConsentAccountInfoStore),
    contractId() {
  ...
  methods: {
    ...
    ...mapActions(useConsentAccountInfoStore, ['setInfo']),
  ...
  mounted() {
    ...
    const savedAccountInfo = this.consentAccountInfoStore.getInfo(this.contractId);
    if (savedAccountInfo) {
