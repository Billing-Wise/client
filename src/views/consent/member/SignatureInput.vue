  ...
  <div class="signature-input">
    ...
    <div class="signature-options">
      <div class="upload-option">
        ...
        <p>아래와 같은 양식의 사인 이미지를 업로드 하는 방식입니다.</p>
        
        <div class="signature-images">
          <img src="@/assets/images/sign.png" alt="Signature Example 1">
...
export default {
  ...
  methods: {
    ...
    selectUploadOption(option) {
      if (option === 'upload') {
        this.$router.push({ name: 'memberUploadSignature', params: { contractId: this.contractId } });
      } else if (option === 'draw') {
        this.$router.push({ name: 'memberDrawSignature', params: { contractId: this.contractId } });
      }
    },
    checkAndLoadData() {
