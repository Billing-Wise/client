<template>
  <div class="contract-create">
    ...
    :class="{ 'info-box': true, 'active': contractCreateStore.step === 2 }">
      ...
      <div class="double-info">
        <TitleInfoVue title="약정일" :info="contractCreateStore.contractCycle" />
        <TitleInfoVue title="납부 기한" :info="contractCreateStore.paymentDueCycle" />
      </div>
      <div class="double-info">
...
export default {
  ...
  methods: {
    ...mapActions(useContractCreateStore, ['setStep'])
  }
}
</script>
